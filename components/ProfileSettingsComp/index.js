      ...
      headerTitle: () => (
        <View style={{ flexDirection: "row" }}>
          ...
          <Text style={{ marginLeft: 10, fontSize: 18 }}>
            {page === option ? "Group " : null}Profile Settings
          </Text>
        </View>
      ),
    });
      ...
      <View style={styles.wraperPer}>
        ...
        <View style={styles.viewChild}>
          ...
          >
            <View
              style={
                state == "public" ? styles.viewCheck : styles.viewChecknormal
              }
            ></View>
          </TouchableOpacity>
        </View>
        <View style={styles.viewChild}>
          ...
          >
            <View
              style={
                state == "private" ? styles.viewCheck : styles.viewChecknormal
              }
            ></View>
          </TouchableOpacity>
        </View>
        <View style={styles.viewChild}>
          ...
          >
            <View
              style={
                state == "followers" ? styles.viewCheck : styles.viewChecknorma
              }
            ></View>
          </TouchableOpacity>
        </View>
