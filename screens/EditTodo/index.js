...
<AntDesign name="camera" size={32} color="black" />
       ...
       <View style={{width:'100%',marginLeft:20}}>
         ...
         <View
           ...
           <TouchableOpacity
           style={{width:170,height:40,backgroundColor:'#1E90FF',alignSelf:'center',justifyContent:'center',alignItems:'center',marginTop:20,marginLeft:-30,borderRadius:10}}
           >
               <Text style={{color:'white',fontSize:15}}>Add Todo</Text>
           </TouchableOpacity>
       </View>
              </View>
            </ImageBackground>
