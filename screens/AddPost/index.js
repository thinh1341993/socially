...
const AddPost = ({ route }) => {
  ...
  useEffect(() => {
    if (route?.params?.photos) {
      uploadImage(route?.params.photos, "image");
    }
  }, [route]);
  ...
  const renderCancelPreviewButton = () => (
    <View>
      ...
      <TouchableOpacity
        activeOpacity={0.8}
        style={{ top: 35, right: 15, position: "absolute" }}
        onPress={() => done()}
      >
        <Text style={{ fontSize: 18, color: "#49cbe9", fontWeight: "600" }}>
          Done!
        </Text>
      </TouchableOpacity>
    </View>
  ...
  const renderPlaybackSpeed = () => (
    <View style={styles.playbackSpeedTab}>
      <View style={styles.playbackSpeedOption}>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
            backgroundColor: selectedSpeed === "0.25" ? "#49cbe9" : "#FFFFFF",
            padding: 5,
            borderRadius: 5,
          }}
          onPress={() => {
      ...
      <View style={styles.playbackSpeedOption}>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
            backgroundColor: selectedSpeed === "0.75" ? "#49cbe9" : "#FFFFFF",
            padding: 5,
            borderRadius: 5,
          }}
          onPress={() => {
      ...
      <View style={styles.playbackSpeedOption}>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
            backgroundColor: selectedSpeed === "1" ? "#49cbe9" : "#FFFFFF",
            padding: 5,
            borderRadius: 5,
          }}
          onPress={() => {
      ...
      <View style={styles.playbackSpeedOption}>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
            backgroundColor: selectedSpeed === "1.5" ? "#49cbe9" : "#FFFFFF",
            padding: 5,
            borderRadius: 5,
          }}
          onPress={() => {
      ...
      <View style={styles.playbackSpeedOption}>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
            backgroundColor: selectedSpeed === "2.5" ? "#49cbe9" : "#FFFFFF",
            padding: 5,
            borderRadius: 5,
          }}
          onPress={() => {
            setPlaybackSpeed(2.5);
            setSelectedSpeed("2.5");
          }}
        >
          <Text style={{ fontSize: 18, color: "black", fontWeight: "600" }}>
            2.5
      ...
      <View style={styles.playbackSpeedOption}>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
            backgroundColor: selectedSpeed === "3" ? "#49cbe9" : "#FFFFFF",
            padding: 5,
            borderRadius: 5,
          }}
          onPress={() => {
  ...
  const done = async () => {
    let videoMp4 = videoSource;
    await cameraRef.current.resumePreview();
    setIsPreview(false);
    setStartCamera(false);
    setVideoSource(null);
    !videoMp4 && setEdit(true);
    videoMp4 && uploadImage(videoMp4, "video");
    //uploadImage(source);
  };
  ...
  const renderCaptureControl = () => (
    <View style={styles.control}>
      <TouchableHighlight
        ...
        style={[
          styles.capture,
          { backgroundColor: press ? "#49cbe9" : "white" },
        ]}
      />
    </View>
  );
  ...
  const uploadImage = async (uri, type) => {
    ...
    console.log("sdfsdfsdfsd", uri);
    const blob = await response.blob();
    var ref = firebase
      .storage()
      .ref()
      .child(
        `${type === "image" ? "images" : "video"}/${Math.floor(
  ...
  if (edit) {
    return <ImageEditorComp uri={source} onPress={uploadImage} />;
  }
              ...
              >
                ...
                >
                  ...
                  <TouchableOpacity
                    ...
                    style={{ marginTop: 20, height: 25, width: 25 }}
                  >
