  ...
  useEffect(() => {
    ...
    const runAsync = async () => {
      try {
        if (!isCancelled) {
          //   do the job
          if (!verificationId && !loading) textInput.focus();
        }
      } catch (e) {
        if (!isCancelled) {
          throw e;
          ...
          >
            ...
            <View>
              {!verificationId ? (
                ...
                <Text style={{fontSize:30, fontWeight:'bold',color:'black', marginLeft:20, marginTop:20,width:250}}>Enter your Mobile number</Text>
                <Text style={{color:'black',marginLeft:20,marginBottom:20}}>We will secd you confirmation code</Text>
                </View>
                  <View
                    style={[
                  ...
                  >
                    ...
                    <TextInput
                      ...
                      style={{borderRadius:5,borderWidth:0.5,marginLeft:10,width:200,}}
                    />
                  </View>
                  ...
                  <View style={styles.viewBottom}>
                    <TouchableOpacity
                      onPress={() =>
                        navigation.navigate("Login", { loginDirect: true })
                      }
                      activeOpacity={0.8}
                    >
                    ...
                    <View>
                      <Text style={styles.textDetail}>
                        You may receive SMS updates from Socially and can opt out
                        at any time.
                      </Text>
                    </View>
